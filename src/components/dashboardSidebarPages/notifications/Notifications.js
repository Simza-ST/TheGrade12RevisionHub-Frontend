...
import NotificationList from './NotificationList';
import Header from "../../common/Header";
import { recordActivity } from '../../../utils/activityUtil.js'; //import utility
...
// Fetch initial notifications
    ...
    const markAllAsRead = async () => {
        try {
            ...
            setNotifications(notifications.map((n) => ({ ...n, read: true })));
            onActivity('Marked all notifications as read'); //Record Activity
        } catch (error) {
            setError('Error marking all notifications as read');
            console.error('Error marking all notifications as read:', error);
            try {
...
Notifications.propTypes = {
    ...
    setNotifications: PropTypes.func.isRequired,
    onActivity: PropTypes.func.isRequired,  //added onActivity prop
};
