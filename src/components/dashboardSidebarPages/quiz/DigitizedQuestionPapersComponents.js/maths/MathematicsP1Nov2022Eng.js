...
const MathematicsP1Nov2022Eng = ({ paperId }) => {
    ...
    // Answer key and solutions remain unchanged
    const answerKey = {
        'q1-1-1a': ["x=2", "2"],
        'q1-1-1b': ["x=-2", "-2"],
        'q1-1-2a': ["x=2.82", "2.82"],
            ...
            <div className="input-container">
                ...
                {showResults && (
                    <div className="solution-buttons">
                        <button className="solution-button" onClick={() => showAnswer(questionId)}>
                            View Answer
                        </button>
                        <button className="solution-button" onClick={() => showSolution(questionId)}>
                            View Solution
                        </button>
                    </div>
                )}
                ...
                <div className="question">
                    <div className="sub-question">
                        ...
                        <div className="sub-question">
                            ...
                            {renderPairedInputs('q1-1-1a', 'q1-1-1b', '(e.g., x = 2)', '(e.g., x = -2)')}
                        </div>
                        <div className="sub-question">
                            <p>1.1.2 <span className="equation">2x² - 6x + 1 = 0</span> (correct to TWO decimal places)</p>
                            {renderPairedInputs('q1-1-2a', 'q1-1-2b', '(e.g., x = 2.82)', '(e.g., x = 0.18)')}
                        </div>
                        <div className="sub-question">
                            <p>1.1.3 <span className="equation">x² - 90 > x</span></p>
                            {renderPairedInputs('q1-1-3a', 'q1-1-3b', 'First region (e.g., x < -9)', 'Second region (e.g., x > 10)')}
                        </div>
                        <div className="sub-question">
                            <p>1.1.4 <span className="equation">x - 7√x = -12</span></p>
                            {renderPairedInputs('q1-1-4a', 'q1-1-4b', 'First answer (e.g., x = 9)', 'Second answer (e.g., x = 16)')}
                        </div>
                    </div>
                    <div className="sub-question">
                        ...
                        {renderCoordinateInputs('q1-2a-x', 'q1-2a-y', 'x (e.g., 2)', 'y (e.g., 2)')}
                        <label>Second Solution:</label>
                        {renderCoordinateInputs('q1-2b-x', 'q1-2b-y', 'x (e.g., -1)', 'y (e.g., -4)')}
                    </div>
                    <div className="sub-question">
                    ...
                    <div className="sub-question">
                        ...
                        {renderCoordinateInputs('q1-4-x', 'q1-4-y', 'x (e.g., 1)', 'y (e.g., 1)')}
                    </div>
                </div>
            </div>
            ...
            <div className="question-section">
                ...
                <div className="question">
                    <div className="sub-question">
                        ...
                        <div className="sub-question">
                            <p>2.1.2 Determine the number of consecutive terms that must be added to the first 6 terms of the series to obtain a sum of 114674.</p>
                ...
                <div className="question">
                    <div className="sub-question">
                        ...
                        <div className="sub-question">
                            ...
                            {renderPairedInputs('q3-4a', 'q3-4b', 'First term (e.g., T₇₆)', 'Second term (e.g., T₇₇)')}
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="question">
                    <div className="sub-question">
                        ...
                        <div className="sub-question">
                            ...
                            {renderCoordinateInputs('q4-1-1-p', 'q4-1-1-q', 'p (e.g., -1)', 'q (e.g., 2)')}
                        </div>
                        <div className="sub-question">
                            <p>4.1.2 Calculate the coordinates of the <i>x</i>-intercept of <i>h</i>.</p>
                            {renderCoordinateInputs('q4-1-2-x', 'q4-1-2-y', 'x (e.g., 1/2)', 'y (e.g., 0)')}
                        </div>
                        <div className="sub-question">
                        ...
                        <div className="sub-question">
                            ...
                            {renderPairedInputs('q4-1-5a', 'q4-1-5b', 'First region (e.g., x ≤ 1/2)', 'Second region (e.g., x > 1)')}
                        </div>
                    </div>
                    <div className="sub-question">
                        ...
                        <div className="sub-question">
                            ...
                            {renderCoordinateInputs('q4-2-2-x', 'q4-2-2-y', 'x (e.g., 2)', 'y (e.g., -9)')}
                        </div>
                        <div className="sub-question">
                            <p>4.2.3 Determine the values of <i>a</i> and <i>q</i>.</p>
                            {renderCoordinateInputs('q4-2-3-a', 'q4-2-3-q', 'a (e.g., -1)', 'q (e.g., -5)')}
                        </div>
                        <div className="sub-question">
                ...
                <div className="question">
                    <div className="sub-question">
                        ...
                        <div className="sub-question">
                            ...
                            {renderCoordinateInputs('q5-3-x', 'q5-3-y', 'x (e.g., -6)', 'y (e.g., -6)')}
                        </div>
                        <div className="sub-question">
                ...
                <div className="question">
                    <div className="sub-question">
                        ...
                        <div className="sub-question">
                            ...
                            <div className="input-group triple-inputs">
                        ...
                        <div className="sub-question">
                            ...
                            <div className="sub-question">
                                ...
                                {renderCoordinateInputs('q8-2-1a-x', 'q8-2-1a-y', 'x (e.g., -1/3)', 'y (e.g., 49/27)')}
                                <label>Second Turning Point:</label>
                                {renderCoordinateInputs('q8-2-1b-x', 'q8-2-1b-y', 'x (e.g., 1)', 'y (e.g., 3)')}
                            </div>
                            <div className="sub-question">
