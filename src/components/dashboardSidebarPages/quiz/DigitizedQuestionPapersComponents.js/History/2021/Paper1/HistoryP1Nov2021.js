...
function HistoryP1Nov2021() {
    ...
    // Keyword-based correct answers for each question
    const correctAnswers = {
        // ... (keep your existing correctAnswers object)
        // Question 1 keywords
        '1.1.1': ['black local government bill'],
        '1.1.2': ['local government structures', 'autonomy', 'self-government'],
        '1.1.3': ['high rentals', 'poor electrification', 'bad housing', 'bucket-toilet system', 'crime'],
        '1.1.4': ['bread-and-butter', 'political issues', 'politicised', 'conscientised'],
        '1.2.1': ['mobilise', 'protest', 'residents meeting', 'community organising'],
        '1.2.2': ['civic associations', 'community leadership', 'dr motlana', 'resistance'],
        '1.3.1': ['azanian peoples organisation', 'azapo'],
        '1.3.2': ['rent boycott', 'organiser', 'activist', 'leader'],
        '1.3.3': ['detention', 'solitary confinement', 'fourteen days', 'no lawyer', 'no doctor'],
        '1.3.4': ['refuse to pay rent', 'protest', 'withhold payment', 'boycott'],
        '1.3.5': ['collaborators', 'apartheid system', 'puppets', 'superintendent'],
        '1.4.1': ['rent increase', 'budget deficits', 'self-financing', 'escalating rents'],
        '1.4.2': ['attacks on councillors', 'community pressure', 'resignations', 'unpopular'],
        '1.4.3': ['mass killing', 'shooting', 'police violence', 'shoot-to-kill'],
        '1.4.4': ['truth and reconciliation commission', 'official report', 'government reaction'],
        '1.5': ['protests', 'black local authorities', 'resistance', 'community mobilisation'],
        '1.6': ['civic organisations', 'mobilise', 'resist', 'apartheid structures', 'community organising', 'rent boycotts', 'protests'],

        // Question 2 keywords
        '2.1.1': ['july 1980', 'about july 1980'],
        '2.1.2': ['vusumzi pikoli', 'thozi majola', 'phaki ximiya'],
        '2.1.3': ['underground movement', 'build underground', 'mission', 'political work'],
        '2.1.4': ['traitor', 'betrayer', 'informer', 'disloyal'],
        '2.2.1': ['van renburg', 'du plessis', 'gerrit erasmus'],
        '2.2.2': ['testimony', 'evidence', 'statement', 'amnesty hearing'],
        '2.2.3': ['remorseful', 'amnesty', 'stand trial', 'forgiveness'],
        '2.2.4': ['cannot forgive', 'no forgiveness', 'trauma', 'barbarians'],
        '2.3.1': ['spiritual repatriation', 'closure', 'family', 'memorial'],
        '2.3.2': ['best friend', 'comrade', 'fellow activist', 'cell member'],
        '2.3.3': ['closure', 'healing', 'spiritual', 'burial'],
        '2.4.1': ['poisoned', 'tortured', 'shot', 'burnt', 'bombed'],
        '2.4.2': ['spiritual repatriation', 'closure', 'no body', 'memorial'],
        '2.4.3': ['moment of reflection', 'national healing', 'reconciliation', 'reflection'],
        '2.4.4': ['reliable source', 'official ceremony', 'minister', 'documented'],
        '2.5': ['closure', 'forgiveness', 'reconciliation', 'family perspective'],
        '2.6': ['truth and reconciliation commission', 'closure', 'forgiveness', 'family healing'],

        // Question 3 keywords
        '3.1.1': ['sit-in'],
        '3.1.2': ['protest action', 'withholding support', 'boycott'],
        '3.1.3': ['beginning', 'spread', 'inspired', 'growth', 'impatience'],
        '3.2.1': ['joseph jackson jr'],
        '3.2.2': ['segregation', 'discrimination', 'jim crow', 'coloured library'],
        '3.2.3a': ['marching', 'confederate flag'],
        '3.2.3b': ['cheer', 'supporters', 'tougaloo nine'],
        '3.2.4': ['interview', 'first-hand', 'leader', 'reliable'],
        '3.3.1': ['swimming together', 'integrated', 'protest', 'desegregation'],
        '3.3.2': ['uncomfortable', 'anxious', 'uncertainty', 'integration'],
        '3.4.1': ['relented', 'lost business', 'first black customers', 'integration', 'civil rights act'],
        '3.4.2': ['racial divisions', 'equal', 'public facilities'],
        '3.4.3': ['hotels', 'restaurants', 'theatres', 'retail stores'],
        '3.4.4': ['civil rights act'],
        '3.4.5a': ['relieved', 'broken chains', 'segregation'],
        '3.4.5b': ['cleansed', 'overcome stigma', 'dignity'],
        '3.5': ['reasons', 'achievements', 'growth', 'impact', 'woolworths'],
        '3.6': ['february 1960', 'thousand students', 'fifty thousand', 'kneel-ins', 'read-ins', 'swim-ins', 'tougaloo nine', 'integrated pool', 'civil rights act'],

        // Essay keywords
        'essay-vietnam': ['guerrilla warfare', 'tet offensive', 'operation rolling thunder', 'agent orange', 'vietnamisation', 'public opinion', 'my lai', 'withdrawal'],
        'essay-congo': ['mobutu', 'authenticité', 'zaireanisation', 'one-party state', 'kleptocracy', 'economic collapse', 'africanisation', 'authoritarianism'],
        'essay-black-power': ['black panther party', 'malcolm x', 'stokely carmichael', 'self-defence', 'black pride', 'community programs', 'police brutality', 'empowerment']
    };
...
export default HistoryP1Nov2021;