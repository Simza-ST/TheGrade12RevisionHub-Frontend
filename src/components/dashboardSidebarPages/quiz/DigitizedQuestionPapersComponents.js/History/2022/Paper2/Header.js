...
const Header = ({ onTimeUp, onTimeUpdate, isExamSubmitted }) => {
    ...
    }, [isExamSubmitted, onTimeUp, onTimeUpdate, examDuration]); // ADD examDuration to dependencies
    ...
    return (
        <div className="exam-header">
            ...
            <p className="exam-subtitle">Paper 2 - The Coming of Democracy in South Africa and Remembrance of the Past</p>
