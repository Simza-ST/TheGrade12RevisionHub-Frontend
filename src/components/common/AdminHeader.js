...
const AdminHeader = ({ user, notifications, isCollapsed, darkMode, setDarkMode, tabDescription, userMessage }) => {
        ...
        >
            <div className="bg-[var(--bg-secondary)] p-6 rounded-2xl shadow-md flex justify-between items-center">
                <div>
                    ...
                    <p className="text-sm mt-1 text-[var(--text-secondary)]">{userMessage}.</p>
                </div>
